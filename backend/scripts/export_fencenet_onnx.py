...
CLASS_NAMES = FenceNetV2.CLASS_NAMES
NUM_CHANNELS = 18
SEQUENCE_LENGTH = 28
DEFAULT_CHECKPOINT = BACKEND_DIR / "weights" / "fencenet" / "best_model.pth"
DEFAULT_OUTPUT = REPO_ROOT / "android" / "app" / "src" / "main" / "assets" / "fencenet_v2.onnx"
